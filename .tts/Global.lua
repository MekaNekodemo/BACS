local HEXNODE_DISTANCE_THRESHOLD = 0.9
    ...
    if (#hexNodes == 0) then
        ...
        while (pointer <= #hexNodes) do
            ...
            if (pointerHexNode.call("getHasFullNeighbours")) then
                ...
                print("→ _fillNodeWithNeighbours called with:")
                print("   mainPointer =", pointer)  
                print("   pointerHexNode GUID =", pointerHexNode.getGUID())
                print("   pointerHexNode Name =", pointerHexNode.getName())
                print("   #hexNodes =", #hexNodes)
                _fillNodeWithNeighbours(pointer, pointerHexNode, hexNodes) 
                pointer = pointer + 1
            end
        end
    end
...
local function _fillNodeWithNeighbours(mainPointer, pointerHexNode, hexNodes)
